...
#[AsCommand(
    name: 'github:subscriptions:balancing',
    description: 'Отписывает от пользователей, которые не подписались на целевого пользователя,'
                 . ' но на которых подписан целевой пользователь.'
)]
class GithubSubscriptionsBalancingCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->subscriptionManager->subscriptionsBalancing($targetUserToken, $targetUsername);
